...
- `blocked`, `timeout`, and `rate_limited` are `unable_to_verify`, with no status delta. AI advice is retained for review but cannot create categories, merge identities, or close records.
