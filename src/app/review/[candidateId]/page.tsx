...
export default async function CandidateReviewPage({ params }: { params: Promise<{ candidateId: string }> }) {
  ...
  return <main className="work-surface">
    ...
    <section className="page-intro">
      ...
      {candidate.kind === "new_resource" && candidate.status === "approved" ? <p><strong>Awaiting map handoff.</strong> Approval is recorded, but no Azure insert or export is available.</p> : null}
    </section>
