...
export function RunActions({ runId, status, resumeHeadroom }: { runId: string; status: RunStatus; resumeHeadroom: number }) {
  ...
  return <section className="actions" aria-label="Audit run controls">
    {status === "paused" ? <>
      <label className="resource-search">Additional checkpoint budget
